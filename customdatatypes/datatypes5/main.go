...
import (
	...
	"github.com/erankitcs/golang_learning/customdatatypes/datatypes5/organisation"
)
...
func main() {
	...
	p := organisation.NewPerson("Ankit", "Singh", organisation.NewEuropeanUnionIdentifier("123-445-3455", "UK"))
